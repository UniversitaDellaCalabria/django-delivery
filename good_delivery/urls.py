...
urlpatterns = [
    ...
    path(f'{op_prefix_camp}/<int:campaign_id>/<int:delivery_id>/return/', operator_good_delivery_return, name='operator_good_delivery_return'),
    path(f'{op_prefix_camp}/<int:campaign_id>/<int:delivery_id>/disable/', operator_good_delivery_disable, name='operator_good_delivery_disable'),
    path(f'{op_prefix_camp}/<int:campaign_id>/<int:delivery_id>/delete/', operator_good_delivery_delete, name='operator_good_delivery_delete'),
    path(f'{op_prefix_camp}/<int:campaign_id>/<int:delivery_id>/send-token/', operator_good_delivery_send_token, name='operator_good_delivery_send_token'),
